...
import { RECOVER_INITIAL_VALUE } from "../constants/initialValues";
import { recoverPassword, reset } from "../features/Auth/AuthSlice";
import { validationRecoverPass } from "../helpers/validations";
...
const ForgotPass = () => {
  ...
  const { values, handleChange, handleSubmit, errors } = useForm(
    RECOVER_INITIAL_VALUE,
    recoverPassword,
    validationRecoverPass
  );
