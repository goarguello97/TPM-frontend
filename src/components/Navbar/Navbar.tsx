    ...
    <div className="fixed bottom-[0px] w-[100vw] h-[82px] fold-horizontal:h-[47px] bg-navbar rounded-t-[40px] flex justify-between z-10">
      <Link to="/users" className="flex">
        <svg
          ...
          height="21"
          fill="none"
          className="ms-[67px] my-auto fill-none"
        >
          <path
            fill={
              pathname === PATH.USERS
                ? styleIcon.currentPage
                : styleIcon.otherPageMobile
            }
      ...
      <Link to="/stadistics" className="flex">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="23"
          height="20"
          fill="none"
          className="my-auto fill-none"
        >
          <path
            stroke={
      ...
      <Link to="/profile" className="flex">
        <svg
          ...
          width="20"
          height="22"
          className="me-[67px] my-auto fill-none"
        >
          <circle
            cx="9.845"
            cy="5.665"
